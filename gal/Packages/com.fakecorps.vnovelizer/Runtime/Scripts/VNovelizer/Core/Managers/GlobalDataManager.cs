...
public class GlobalDataManager : BaseManager<GlobalDataManager>
{
    ...
    private void ApplyDisplaySettings()
    {
        if (globalData != null)
        {
            var mode = globalData.IsFullScreen ? FullScreenMode.FullScreenWindow : FullScreenMode.Windowed;
            Screen.SetResolution(globalData.ScreenWidth, globalData.ScreenHeight, mode);
        }
    }
